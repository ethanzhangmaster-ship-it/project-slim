...
def save_card_previews_from_cards(
    ...
    *,
    ...
    write_preview_overview(
        ...
        tecdo_probe_markdown=(output_dir / f"tecdo_probe_{stamp}.md"),
        tecdo_account_reconciliation_markdown=(output_dir / f"tecdo_account_reconciliation_{stamp}.md"),
        tecdo_sync_checklist_markdown=(output_dir / f"tecdo_sync_checklist_{stamp}.md"),
