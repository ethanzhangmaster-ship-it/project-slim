...
print("=" * 60)
print("P04 Witch 广告创建 - 最终版（不带 message）")
print("=" * 60)
print(f"账户: {ad_account_id}")
print(f"图片数量: {len(manifest['images'])}")
print(f"关键修正: 去掉 link_data 中的 message 字段")
print()
...
print(f"\n【步骤 4/5】创建 Creatives（不带 message）...")
creative_ids = []
...
print("\n注意：广告状态应为 PENDING_REVIEW（审核中），不是 WITH_ISSUES")
print("请在 Facebook 后台检查，没问题后手动开启")
