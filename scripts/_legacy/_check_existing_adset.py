...
adset_id = '120249161378170444'  # P4-AND-Purchase-AI-img-0630

r = requests.get(f'{BV}/{adset_id}', params={
    'access_token': TOKEN,
    'fields': 'id,name,optimization_goal,status,daily_budget,targeting,promoted_object,billing_event,bid_strategy'
}, timeout=30)
