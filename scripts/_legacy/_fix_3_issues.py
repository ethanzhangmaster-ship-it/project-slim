"""修复3个问题：广告主、文案、图片（AEO需要pixel，稍后处理）"""
...
ad_copies = [
    {
        "body": "Merge Witches - The most addictive merge puzzle game! Merge witches to unlock powerful spells and magical abilities. Download now and start your magical journey!",
        "title": "Merge Witches",
        "subtitle": "Play Now!",
    },
    {
...
print("3. 添加了广告文案(message)、标题(title)、副标题(subtitle)")
print("4. 使用了新图片")
print("\n⚠️  AEO购物事件需要配置 pixel 和转化事件，当前账户没有 pixel")
print("请在 Facebook 后台配置 pixel 后，我再帮你改成 AEO")
